...
m = Magic.find_or_create_by!( name: :magic_missile, trait: :mem, difficulty: 2, damage_id: _1d4.id, reach: 10 )

_1d2 = Damage.find_or_create_by!( dices_side: 4, nb_dices: 1, bonus: 0 )
m = Magic.find_or_create_by!( name: :imp_blast, trait: :mem, difficulty: 2, damage_id: _1d2.id, reach: 10 )
